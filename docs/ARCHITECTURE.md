...
- V118 makes `bonus_points` the sole current daily bonus value, migrates canonical bonus activities and current snapshot facts, versions the manual bonus rule, and removes the duplicate `power_points` column.
