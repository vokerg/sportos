...
3. Provision a separate Neon activity-detail project with its own schema-owner and `sportos_app` runtime role, then run the primary migrations through V123 and the dedicated activity-detail migration before starting the new runtime.
