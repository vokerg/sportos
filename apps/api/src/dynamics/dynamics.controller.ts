...
import { DYNAMICS_METRICS, type DynamicsGranularity, type DynamicsMetric, type DynamicsQuery } from './dynamics.contracts.js';
...
export class DynamicsController {
  ...
  @Get()
  read(@Query() raw: Record<string, unknown>, @CurrentAccount() account?: AuthenticatedAccount) {
